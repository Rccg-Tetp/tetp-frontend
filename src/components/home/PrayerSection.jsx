const PrayerSection = () => {
  return (
    <section>
      ...
      <div className="pb-[3.25rem] md:flex md:justify-between md:gap-[140px] lg:gap-[300px]">
        <div className="flex items-center justify-start">
          <div className="relative h-fit">
            ...
            <img
              ...
              alt="prayer"
              className="absolute top-[7.125rem] left-[4.5rem] rounded-[10px] max-w-[17.75rem] object-center z-[1] md:top-[156px] md:left-[110px] lg:max-w-[506px] lg:h-[352px] md:max-w-[320px] md:h-[352px]"
            />
          </div>
        </div>
