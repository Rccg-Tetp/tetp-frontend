function Benefit() {
  return (
    <section className="w-full">
      <div className="flex flex-col items-center text-center gap-[25px] pt-[75px]">
        <h3 className="font-normal text-xl font-lateef uppercase">BENEFITS</h3>
        <h1 className="font-satoshi text-2xl font-medium uppercase md:text-[28px]/[37.8px] md:w-[432px]">
          THE benefits of joining our church
        </h1>
      </div>

      <div className="flex flex-col mt-[76px] gap-[90px] mb-[221px] md:mt-[116px]">
