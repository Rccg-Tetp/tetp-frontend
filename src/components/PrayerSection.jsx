const PrayerSection = () => {
  return (
    <section className="pb-[3.25rem] md:flex md:justify-between">
      <div className="relative h-fit">
        <div className="w-[164px] h-[223px] border-orange-650/[63%] border-[3.5px] rounded-[20px] ml-[35px] mt-[50px] md:w-[260px] md:h-[446px] md:ml-[80px] md:mt-[114px]"></div>
        <img
      ...
      <div className="flex flex-col mt-[100px] text-center w-[335px] mx-auto md:mx-0 md:text-left md:w-[606px] md:mr-[122px] md:mt-[146px]">
        <h4 className="uppercase font-lateef text-base font-normal text-[#161722] md:text-xl">
          Prayer
        </h4>
        <h2 className="text-xl font-bold uppercase font-satoshi text-[#161722] mt-[21px] md:text-[28px]/[64px]">
          let us pray for you
        </h2>
        ...
        <div className="flex flex-col md:flex-row md:gap-[56px] md:mt-[39px]">
